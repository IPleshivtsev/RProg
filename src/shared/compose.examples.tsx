...
const filteredComments = comments.filter(pipe(pick('id'), isEqual(22))); // Все комментарии которые равны 22
const filteredComments1 = comments.filter(pipe(pick('id'), isEqual(22), cond)); // Все комментарии, которые НЕ равны 22
